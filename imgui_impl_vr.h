...
IMGUI_API void        ImGui_Impl_VR_RenderDrawLists(ImDrawData* draw_data);

IMGUI_API void        SetCurrentContextToActiveTexture();
...
IMGUI_API void      ImGui_Impl_VR_SetGuiPose(glm::mat4& P);
...
IMGUI_API void		  ImGui_Impl_VR_TriggerHapticPulse(vr::TrackedDeviceIndex_t device, short int duration);
